...
% MOtivation: topic important , business stakeholder for the real world
%% Problem statement : what the problem?? Comparison to other methods, completeness ???  
%% Research qustions::  Ask questions about the topic ??? 
...
% About enhancement
% About the model repair
%  model enhancement of 
%  from Fahland's method to Dees's Anja's
% To incorporate the negative instances into model
%  of Stijin Goedertier, and the methods later, two or three
%% Now comes to my methods
...
%% High level overview... Elements, long-term dependency, === refinement stage, To improve the model precision, add long-term dependency..
%% Simple examples, on base structure...  Postprocess,
%% show screen shoots.
...
\begin{figure}[!h]
	...
	\begin{subfigure}[a]{\textwidth}
		\includegraphics[width=\textwidth]{LT_Seq_01_Silent_01.png}
	...
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[width=\linewidth]{LT_Seq_01_Silent_03.png}
	...
	\begin{subfigure}[c]{\textwidth}
		\centering
		\includegraphics[width=\linewidth]{LT_Seq_01_Silent_02.png}
...
\begin{figure}[!h]
	\includegraphics[width=\textwidth]{LT_Seq_01_FullDuplicated.png}
...
\begin{figure}[!h]
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{LT_Seq_01_SemiDuplicated.png}
	...
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[width=\linewidth]{LT_Seq_01_SemiDuplicated_Problem2.png}
		\caption{For situation 5}
...
\begin{figure}[!h]
	...
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[width=\linewidth]{LT_Seq_01_Silent_03_AfterAddition.png}
	...
	\begin{subfigure}[c]{\textwidth}
		\centering
		\includegraphics[width=\linewidth]{LT_Seq_01_Silent_02_AfterAddition.png}
...
\section{Evaluation}
%% Comparison to other methods, three ways, but if we compare it, we need to put the related work ahead of us. 
\section{Discussion}
%%  Critical about my work.. Complexity, duplicated events, further work??  Limits, future work.. 
...
\section{Conclusion}
%% What I have donem and I have done
%% 
One page is enough. 

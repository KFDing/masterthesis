...
\begin{figure}[!h]
	...
	\end{subfigure}%
\end{figure}
%% Here add the definition for silent transitions and the token, also the firing rule
...
Soundness is used to describe if a Petri net is a workflow net with unique start place and unique end place. 

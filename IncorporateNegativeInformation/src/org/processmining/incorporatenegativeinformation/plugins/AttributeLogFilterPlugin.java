 ...
 *
 */
@Plugin(name = "Adpated Filter Log by Attributes", parameterLabels = { "a log", "filter settings" }, //
		returnLabels = { "filtered log" }, returnTypes = {
				XLog.class }, userAccessible = true, help = "Adapted Filter traces and individual events from the log based on the presence or absence of attributes with particular values.", mostSignificantResult = 1)

 ...
 * @param <T>
 */
public class NewLTConnection<T>{
	...
	public NewLTConnection(T first, T second) {
		sourceBranch = first;
		targetBranch = second;
	...
	public NewLTConnection(T first, T second, List<Double> values) {
		sourceBranch = first;
		targetBranch = second;
		connectionValues = values;
	}
	
	public T getSourceBranch() {
		return sourceBranch;
	}

	public void setSourceBranch(T firstBranch) {
		this.sourceBranch = firstBranch;
	}

	public T getTargetBranch() {
		return targetBranch;
	}

	public void setTargetBranch(T secondBranch) {
